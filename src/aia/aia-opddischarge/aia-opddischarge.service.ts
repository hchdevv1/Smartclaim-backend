...
import { ResultDataJsonDto ,OPDDischargeResponseDto} from './dto/aia-opddischarge-sent-to-aia.dto';
import {ResultPatientInfoDto ,ResultVisitInfoDto ,ResultDiagnosisInfoDto ,ResultProcedureInfoDto ,ResultInvestigationInfoDto ,ResultDoctorInfoDto
  ,ResultVitalSignInfoDto ,ResultOrderItemInfoDto ,ResultBillingInfoDto ,ResultTotalBillAmountInfoDto ,ResultAttachDocListInfoDto} from './dto/aia-opddischarge-sent-to-aia.dto';
...
let newOPDDischargeResponseDto =new OPDDischargeResponseDto();
//--> get Patient  <--//
const getOPDDischargePatient = await this.trakcarePatientInfoService.getOPDDischargePatient(RequesetBody.xHN);
...
//--> get Visit  <--//
const getOPDDischargeVisit = await this.trakcarePatientInfoService.getOPDDischargeVisit(RequesetBody.xVN);
...
//--> get VitalSignIn  <--//
const getOPDDischargeVitalSign = await this.trakcarePatientInfoService.getOPDDischargeVitalSign(RequesetBody.xVN);
...
//--> get Diagnosis  <--//
const getOPDDischargeDiagnosis = await this.trakcarePatientInfoService.getOPDDischargeDiagnosis(RequesetBody.xVN);
...
//--> get Procedure  <--//
const getOPDDischargeProcedure = await this.trakcarePatientInfoService.getOPDDischargeProcedure(RequesetBody.xVN); 
...
//--> get Investigation  <--//
const getOPDDischargeInvestigation = await this.trakcarePatientInfoService.getOPDDischargeInvestigation(RequesetBody.xVN); 
...
//--> get OrderItem  <--//
const getOPDDischargeOrderItem = await this.trakcarePatientInfoService.getOPDDischargeOrderItem(RequesetBody.xVN); 
...
//--> get Doctor  <--//
const getOPDDischargeDoctor = await this.trakcarePatientInfoService.getOPDDischargeDoctor(RequesetBody.xVN); 
...
//--> get Billing  <--//
const getOPDDischargeBilling = await this.trakcarePatientInfoService.getOPDDischargeBilling(RequesetBody.xVN); 
...
console.log('------')
const getListDocumentByRefId = await this.utilsService.getListDocumentByRefId2(RequesetBody.xVN,RequesetBody.xRefId,RequesetBody.xTransactionNo); 
...
if (!newOPDDischargeResponseDto) {
  throw new Error('newOPDDischargeResponseDto is undefined');
}
...
//       if (seen.has(value)) {
//         return; // ยกเลิกการเข้าถึงถ้าเป็น circular reference
//       }
//       seen.add(value);
//     }
//     return value;
//   };
// }
const body =newOPDDischargeResponseDto // JSON.stringify(newOPDDischargeResponseDto, removeCircularReferences());


const responsefromAIA = await lastValueFrom(
  this.httpService.post(apiURL, body, { headers })
);
console.log(responsefromAIA.data.Result.Code)
return  responsefromAIA.data.Result //newOPDDischargeResponseDto
 /////////////////////  end  /////////////////////
